...
app.get('/p', async (req, res) => {
 ...
 try {
  ...
  // Cargar las marcas de agua desde URLs remotas
  const watermark1 = await Jimp.read('https://example.com/Wtxt-poster.png');
  const watermark2 = await Jimp.read('https://example.com/Wlogo-poster.png');
